/* PrismJS 1.30.0
https://prismjs.com/download#themes=prism&languages=markup+css+clike+javascript+c+cpp+docker+java+json+jsonp+markup-templating+php+python+sql+typescript+xml-doc&plugins=line-highlight+line-numbers+toolbar+copy-to-clipboard */
