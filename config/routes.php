...
return [
    ...
    Route::post('/post' , [HomeController::class , 'getCode']),
    ...
    Route::get('/admin/posts/update', [PostController::class , 'edit'], [AuthMiddleware::class]),
    Route::post('/admin/posts/update', [PostController::class , 'update'], [AuthMiddleware::class]),
    Route::post('/admin/posts/destroy', [PostController::class , 'destroy'], [AuthMiddleware::class]),
