...
<tr class="bg-neutral-primary-soft border-b border-default hover:bg-neutral-secondary-medium">
    ...
    <td class="px-6 py-2 text-center">
        <div class="inline-flex rounded-base space-x-1" role="group">
            ...
            <!--Button View-->
            <a type="button" href="/admin/parts?id=<?php echo $part->id(); ?>" class="inline-flex items-center text-white bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 font-medium rounded-sm text-sm px-1.5 py-0.5 text-center leading-5">
                <svg class="w-4 h-4 mr-0.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
